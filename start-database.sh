...
DB_PASSWORD=$(echo "$DATABASE2_URL" | awk -F':' '{print $3}' | awk -F'@' '{print $1}')
DB_PORT=$(echo "$DATABASE2_URL" | awk -F':' '{print $4}' | awk -F'\/' '{print $1}')
DB_NAME=$(echo "$DATABASE2_URL" | awk -F'/' '{print $4}')
